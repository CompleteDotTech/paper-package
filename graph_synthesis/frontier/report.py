...
def replace_block(text, body):
    ...
    anchor=next((x for x in ('<!-- UNCERTAINTY_RESEARCH_END -->','<!-- ASSUMPTION_AWARE_RESEARCH_END -->','<!-- SOURCE_STRUCTURAL_RESEARCH_END -->','<!-- STRUCTURAL_RESEARCH_END -->',ANCHOR) if x in text),ANCHOR)
