...
def render(output):
    ...
    markdown = re.sub(r"<!-- (?:FOLLOWUP|ADAPTIVE|RISK_CONTROL|STRUCTURAL|RELIABILITY|SOURCE_STRUCTURAL|FRONTIER)_RESEARCH_(?:START|END) -->", "", source.read_text(encoding="utf-8"))
